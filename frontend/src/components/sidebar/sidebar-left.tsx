...
import { PlatonLogo } from '@/components/sidebar/kortix-logo';
...
export function SidebarLeft({
  ...
  const customAgentsEnabled = false; // flags.custom_agents;
  const marketplaceEnabled = false; // flags.agent_marketplace;
