                ...
                {activeTab === 'terms' ? (
                  <div>
                    ...
                    <p className="text-muted-foreground text-balance mb-6">
                      ...
                      CAREFULLY BEFORE USING THE SERVICES OFFERED BY Platon AI Team AI
                    ...
                    <ul className="text-muted-foreground space-y-1 mb-6">
                      <li>
                        "Company" refers to Platon AI Team AI Corp (701 Tillery Street
                        Unit 12-2521 Austin, Texas 78702, United States).
                      </li>
                      <li>
                        "Site" refers to the Pulsar Agents website, including any related
                        features, content, or applications offered from time to
                        time by the Company.
                      </li>
                      <li>
                        "Service" refers to the Pulsar Agents website and all related
                    ...
                    <p className="text-muted-foreground text-balance mb-6">
                      Pulsar Agents is licensed under the Apache License, Version 2.0.
                    ...
                    <p className="text-muted-foreground text-balance mb-6">
                      All Pulsar Agents logos, marks, and designations are trademarks or
                  ...
                  <div>
                    ...
                    <p className="text-muted-foreground text-balance mb-6">
                      References to our "Services" at Pulsar Agents in this statement
                    ...
                    <p className="text-muted-foreground text-balance mb-6">
                      Pulsar Agents does not collect biometric or identifying
