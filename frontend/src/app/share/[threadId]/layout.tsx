...
export async function generateMetadata({ params }): Promise<Metadata> {
  ...
  const fallbackMetaData = {
    title: 'Shared Conversation | Pulsar Agents',
    description: 'Replay this Agent conversation on Pulsar Agents',
    alternates: {
  ...
  try {
    ...
    const title = projectData.name || 'Shared Conversation | Pulsar Agents';
    const description =
      projectData.description ||
      'Replay this Agent conversation on Pulsar Agents';
