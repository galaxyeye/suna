...
<head>
  ...
  <title>Welcome to Pulsar Agents</title>
  <style>
    body {{
...
<body>
  <div class="container">
    <div class="logo-container">
      <img src="https://i.postimg.cc/WdNtRx5Z/kortix-suna-logo.png" alt="Pulsar Agents Logo" class="logo">
    </div>
    <h1>Welcome to Pulsar Agents!</h1>

    <p>Hi {user_name},</p>

    <p><em><strong>Welcome to Pulsar Agents — we're excited to have you on board!</strong></em></p>
